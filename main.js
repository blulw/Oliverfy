(() => {
  ...
  const numImages = 50;
  const flipExcludedCutoff = 50; //NOTE: this number represents the cutoff for where the non flippable images start
  ...
  //runs the functions
  if (isEnabled) {
    //checks if the user has disabled the plugin or not
